...
public:
    ...
    void SelectServiceCities(Json::Value &root, Json::Value &result);
    ...
    /* Получение информации о геозонах по маршруту */
    void GetGeozonesInfoByRoute(Json::Value &root, Json::Value &result);
    ...
    /* Сменить состояние водителя */
    void SetDriverState(Json::Value &root, Json::Value &result);
    /* Обновить геозоны */
    void RefreshGeozones(Json::Value &root, Json::Value &result);
