...
public:
  virtual void ProcessRequest(CHttpRequest &_cRequest, CHttpResponse &_cResponse);
  ...
  bool CheckToken(const std::string &_strToken, const std::string &_strError, Json::Value &_result);
...
private:
  ...
  void processGetOrderReview(Json::Value &root, Json::Value &result);  
};
