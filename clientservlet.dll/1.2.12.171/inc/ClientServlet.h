...
private:
  ...
  void appendClient(const char *token, Json::Value &root, Json::Value &result );
  void appendClient( DWORD clientId, Json::Value &root, Json::Value &result );
  ...
  void processLKLogin(Json::Value &root, Json::Value &result);
};
