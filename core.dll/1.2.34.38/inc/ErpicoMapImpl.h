...
WMAP_DLL int __stdcall WMCalcRoute(std::string strAddress, std::string &strDistance, std::string &strDuration);
...
typedef int (__stdcall* LPCALCROUTE)(std::string, std::string&, std::string&);
