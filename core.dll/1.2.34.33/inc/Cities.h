...
public:
  ...
  static int GetCities(std::list<sCity> & arrCities, const bool &_bActive = true);
  ...
  static bool InsertCities(const std::list<CCities::sCity> &_lstCities, const bool &_bDelete = false);
  ...
  static void RefreshCache(const bool &_bActive = true);
  static void CheckCache(const bool &_bActive = true);
