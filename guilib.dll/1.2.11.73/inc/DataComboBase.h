...
protected:
  ...
  mutable CCriticalSection m_csArrBaseItems;
...
public:
  ...
  virtual INT_PTR GetItemsCount() const;
  ...
  virtual bool GetItemLabel(INT_PTR nItem, CString& label) const;
  ...
  virtual DWORD GetDataId(const int &_iSel) const { return 0; }
...
protected:
  ...
  bool CheckItemValid(INT_PTR nItem) const;
