...
public:
  ...
  void ResetToCache()
  {
...

    {
      ...
      m_cache->SetDataToCache(m_vectData);
  ...
  void SetData(const std::vector<TData> &_vectData) { m_vectData = _vectData; }
